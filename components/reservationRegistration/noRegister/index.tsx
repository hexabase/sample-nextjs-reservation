...
const NoRegister = () => {
  return (
    <div className='pb-24 pt-5 md:pb-0  md:py-[150px] px-5 md:px-[48px] text-center h-screen'>
      <Image alt='image' src='/imageRegisterPage.png' width={88} height={90} className='inline-block mt-5 mb-[60px] md:mb-0' />
      <p className='font-bold text-base md:text-2xl leading-[35px]'>まだアジェンダが１件も登録されていません</p>
