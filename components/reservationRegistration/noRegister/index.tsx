...
const NoRegister = ({ setRegisterable }: AddNewForm) => {
  return (
    <div className='pb-24 pt-5 md:pb-0 md:py-[100px] px-5 md:px-[48px] text-center h-screen'>
      <Image
        alt='image'
        src='/imageRegisterPage.svg'
        width={88}
        height={90}
        className='inline-block mb-[60px]'
      />
