        ...
        <Grid container>
          ...
          <Grid item xs={12} md={6}>
            <div className='w-4/6 flex flex-col gap-[26px] mx-auto my-0 md:m-0'>
              <p className='text-lg font-bold text-center md:text-start md:font-normal'>
                管理者登録
              </p>
              ...
              <div>
                ...
                >
                  {({
                    ...
                    <form onSubmit={handleSubmit} className='w-full flex flex-col gap-8 h-[478px]'>
